...
public class SelScr5 : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        linkedNum[0] = new List<int> { 1, 2, 6 };
        linkedNum[1] = new List<int> { 0, 2, 4, 7 };
        linkedNum[2] = new List<int> { 0, 1, 4, 5 };
        linkedNum[3] = new List<int> { 5, 6 };
        linkedNum[4] = new List<int> { 1, 2, 5, 6 };
        linkedNum[5] = new List<int> { 2, 3, 4, 6 };
        linkedNum[6] = new List<int> { 0, 3, 4, 5, 7 };
        linkedNum[7] = new List<int> { 1, 6 };
