...
public class SelScr : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        linkedNum[0] = new List<int> { 1, 2, 3 };
        linkedNum[1] = new List<int> { 0, 2, 3 };
        linkedNum[2] = new List<int> { 0, 1, 3, 4 };
        linkedNum[3] = new List<int> { 0, 1, 2, 4 };
        linkedNum[4] = new List<int> { 2, 3 };
